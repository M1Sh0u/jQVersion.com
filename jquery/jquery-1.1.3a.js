...
jQuery.fn = jQuery.prototype = {
	 ...
	 *
	 * @example $("img").length;
	 * @before <img src="../resources/js/jquery-versions/test1.jpg"/> <img src="../resources/js/jquery-versions/test2.jpg"/>
	 * @result 2
	 *
	 * @property
	 * @name length
	 ...
	 * @example $("img").get();
	 * @before <img src="../resources/js/jquery-versions/test1.jpg"/> <img src="../resources/js/jquery-versions/test2.jpg"/>
	 * @result [ <img src="../resources/js/jquery-versions/test1.jpg"/> <img src="../resources/js/jquery-versions/test2.jpg"/> ]
	 ...
	 * @example $("img").get(0);
	 * @before <img src="../resources/js/jquery-versions/test1.jpg"/> <img src="../resources/js/jquery-versions/test2.jpg"/>
	 * @result <img src="../resources/js/jquery-versions/test1.jpg"/>
	 ...
	 * });
	 * @before <img/><img/>
	 * @result <img src="../resources/js/jquery-versions/test0.jpg"/><img src="../resources/js/jquery-versions/test1.jpg"/>
	 ...
	 * @before <img src="../resources/js/jquery-versions/test.jpg"/>
	 * @result test.jpg
	 ...
	 * @before <img/>
	 * @result <img src="../resources/js/jquery-versions/test.jpg" alt="Test Image"/>
	 ...
	 * @before <img/>
	 * @result <img src="../resources/js/jquery-versions/test.jpg"/>
	 ...
	 * @before <img src="../resources/js/jquery-versions/test.jpg" />
	 * @result <img src="../resources/js/jquery-versions/test.jpg" title="test.jpg" />
